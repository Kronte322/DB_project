...
def ADD_NEW_USER(user_nm, user_password, country_name, city_name):
    return 'INSERT INTO st.user(email_nm, password, country_nm, city_nm) VALUES (\'' + user_nm + '\', \'' + user_password + '\', \'' + country_name + '\', \'' + city_name + '\');'
...
def ADD_NEW_SERVER(ip_address, port, country, max_players):
    return 'INSERT INTO st.player(ip_address, port, country, max_players_cnt) VALUES (\'' + ip_address + '\', ' + str(
        port) + ', \'' + country + '\', ' + str(max_players) + ');'
